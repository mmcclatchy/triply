...
function User({ userId }) {
  ...
  return (
    <div>
      <div className={classes.profile_title}>{user.username}'s Profile</div>
            ...
            <>
              <Card variant='outlined' className={classes.card}>
                <CardContent clasName={classes.cardContent}>
                  ...
                  <div className={classes.card_header}>Starting Point</div>
                  <div className={classes.card_info}>
                    {/* {value.startLocation.replace(/"/g, "")} */}
                  </div>
                  <div className={classes.card_header}>Destination</div>
                  <div className={classes.card_info}>
